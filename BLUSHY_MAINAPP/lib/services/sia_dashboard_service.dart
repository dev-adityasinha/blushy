...
class SiaDashboardService {
  ...
  List<Map<String, String>> getSiaObservations({
    ...
    if (list.isEmpty) {
      list.add(SiaDashboardObservation(
        insight: "Sia is continuously learning your wellness rhythm.",
  ...
  SiaMonthlyReflectionData getMonthlyReflectionAndMilestones({
    ...
    final List<MilestoneItem> items = [
      ...
      MilestoneItem(
        ...
        description: 'Engage with Sia for personalized wellness guidance.',
    ...
    final List<String> milestones = [
      ...
      "Sia wellness conversations logged.",
  ...
  String getDailyHeaderBrief({
    ...
    if (hasCycle && phase != null && phase.toLowerCase().contains('menstru') && cycleDay != null) {
      ...
      brief = "Here is your personalized wellness space. Sia has tuned today's insights to support deeper rest, gentle movement, and steady energy.";
    } else {
