...
class ApiPeriodService {
  ...
  Future<ApiResult<PeriodPrediction>> getPredictionsResult() async {
    try {
      ...
      // 401 is "your session ran out", 403 is "you may not see this".
      // Both used to return `restricted`, whose message is written for the
      // partner app -- so an expired login told her that her own cycle had
      // not been shared with her.
      if (res.statusCode == 401) {
        return const ApiResult(state: ApiState.unauthenticated);
      }
