      ...
      if (combinedText.contains('headache') || combinedText.contains('migraine')) {
        insights.add(
          CycleInsight(
            ...
            evidence: "Synthesized directly from your latest Sia AI conversation.",
      ...
      if (combinedText.contains('stress') || combinedText.contains('anxious') || combinedText.contains('anxiety') || combinedText.contains('overwhelm') || combinedText.contains('pressure')) {
        insights.add(
          CycleInsight(
            ...
            evidence: "Derived directly from your active Sia chat session.",
            confidenceLevel: "High",
            timestamp: "Just now",
          ),
        );
      ...
      if (combinedText.contains('fatigue') || combinedText.contains('tired') || combinedText.contains('exhausted') || combinedText.contains('drained') || combinedText.contains('no energy')) {
        insights.add(
          CycleInsight(
            ...
            evidence: "Extracted directly from your recent Sia AI chat.",
            confidenceLevel: "High",
            timestamp: "Just now",
          ),
        );
      ...
      if (combinedText.contains('sleep') || combinedText.contains('insomnia') || combinedText.contains('night')) {
        insights.add(
          CycleInsight(
            ...
            observation: "Talked about sleep challenges with Sia. Maintaining a 19°C cool room setting and avoiding late screens promotes REM sleep.",
      ...
      if (insights.isEmpty && conversationSnippets.isNotEmpty) {
        ...
        insights.add(
          CycleInsight(
            ...
            evidence: "Extracted directly from your active Sia conversation.",
            confidenceLevel: "High",
            timestamp: "Just now",
          ),
        );
    ...
    if (insights.isEmpty) {
      insights.add(
        CycleInsight(
          ...
          observation: "Your daily insights update automatically based on your active Sia AI talks and onboarding choices.",
