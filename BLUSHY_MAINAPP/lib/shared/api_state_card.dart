  ...
  Widget build(BuildContext context) {
    switch (result.state) {
      ...
      case ApiState.unauthenticated:
        // Never `restrictedMessage`: that one says somebody chose not to show
        // this, and an expired session is not a choice anyone made.
        return _MessageBody(
          icon: Icons.login_rounded,
          message: 'Sign in again to see this. Your session has expired.',
